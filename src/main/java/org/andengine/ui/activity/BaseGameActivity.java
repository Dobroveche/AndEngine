...
public abstract class BaseGameActivity extends BaseActivity implements IGameInterface, IRendererListener {
    ...
    public VertexBufferObjectManager getVertexBufferObjectManager() {
        return mEngine != null ? this.mEngine.getVertexBufferObjectManager() : null;
    }

    @Nullable
    public TextureManager getTextureManager() {
        return mEngine != null ? this.mEngine.getTextureManager() : null;
    }
    ...
    public static LayoutParams createSurfaceViewLayoutParams() {
